...
class CreateDocente extends StatefulWidget {
  const CreateDocente({super.key});

  @override
  State<CreateDocente> createState() => _CreateDocenteState();
}

class _CreateDocenteState extends State<CreateDocente> {
  final formNuevoDocente = GlobalKey<FormState>();
  String? nombre;
  String? password;
  String? correo;
  String? tipoUsuario;
  ...
  void guardar() async {
    if (formNuevoDocente.currentState!.validate()) {
      formNuevoDocente.currentState!.save();
